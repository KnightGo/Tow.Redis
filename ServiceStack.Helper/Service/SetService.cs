...
namespace ServiceStack.Helper.Service
{
    ...
    /// </summary>
    public class SetService:RedisBase
    {
        ...
        {
            base._IClient.AddItemToSet(key, value);
        }
        /// <summary>
        /// key集合中添加list集合
        /// </summary>
        ...
        {
            base._IClient.AddRangeToSet(key, list);
        }
        #endregion
        ...
        {
            return base._IClient.GetRandomItemFromSet(key);
        }
        /// <summary>
        /// 获取key集合值的数量
        /// </summary>
        ...
        {
            return base._IClient.GetSetCount(key);
        }
        /// <summary>
        /// 获取所有key集合的值
        /// </summary>
        ...
        {
            return base._IClient.GetAllItemsFromSet(key);
        }
        #endregion
        ...
        {
            return base._IClient.PopItemFromSet(key);
        }
        /// <summary>
        /// 删除key集合中的value
        /// </summary>
        ...
        {
            base._IClient.RemoveItemFromSet(key, value);
        }
        #endregion
        ...
        {
            base._IClient.MoveBetweenSets(fromkey, tokey, value);
        }
        /// <summary>
        ...
        {
            return base._IClient.GetUnionFromSets(keys);
        }
        /// <summary>
        ...
        {
            return base._IClient.GetIntersectFromSets(keys);
        }
        /// <summary>
        ...
        {
            return base._IClient.GetDifferencesFromSet(fromKey, keys);
        }
        /// <summary>
        ...
        {
            base._IClient.StoreUnionFromSets(newkey, keys);
        }
        /// <summary>
        ...
        {
            base._IClient.StoreDifferencesFromSet(newkey, fromkey, keys);
        }
        #endregion
    }
}
