...
namespace ServiceStack.Helper.Service
{
    ...
    /// </summary>
    public class ZSetService:RedisBase
    {
        #region 添加
        /// <summary>
        ...
        {
            return base._IClient.AddItemToSortedSet(key, value);
        }
        /// <summary>
        ...
        {
            return base._IClient.AddItemToSortedSet(key, value, score);
        }
        /// <summary>
        ...
        {
            return base._IClient.AddRangeToSortedSet(key, values, score);
        }
        /// <summary>
        /// 为key添加values集合，values集合中每个value的分数设置为score
        /// </summary>
        ...
        {
            return base._IClient.GetAllItemsFromSortedSet(key);
        }
        /// <summary>
        /// 获取key的所有集合，倒叙输出
        /// </summary>
        ...
        {
            return base._IClient.GetAllItemsFromSortedSetDesc(key);
        }
        /// <summary>
        /// 获取集合，带分数
        /// </summary>
        ...
        {
            return base._IClient.GetAllWithScoresFromSortedSet(key);
        }
        /// <summary>
        /// 获取key为value的下标值
        /// </summary>
        ...
        {
            return base._IClient.GetItemIndexInSortedSet(key, value);
        }
        /// <summary>
        /// 倒叙排列获取key为value的下标值
        /// </summary>
        ...
        {
            return base._IClient.GetItemIndexInSortedSetDesc(key, value);
        }
        /// <summary>
        /// 获取key为value的分数
        /// </summary>
        ...
        {
            return base._IClient.GetItemScoreInSortedSet(key, value);
        }
        /// <summary>
        /// 获取key所有集合的数据总数
        /// </summary>
        ...
        {
            return base._IClient.GetSortedSetCount(key);
        }
        /// <summary>
        ...
        {
            return base._IClient.GetSortedSetCount(key, fromScore, toScore);
        }
        /// <summary>
        ...
        {
            return base._IClient.GetRangeFromSortedSetByHighestScore(key, fromscore, toscore);
        }
        /// <summary>
        ...
        {
            return base._IClient.GetRangeFromSortedSetByLowestScore(key, fromscore, toscore);
        }
        /// <summary>
        ...
        {
            return base._IClient.GetRangeWithScoresFromSortedSetByHighestScore(key, fromscore, toscore);
        }
        /// <summary>
        ...
        {
            return base._IClient.GetRangeWithScoresFromSortedSetByLowestScore(key, fromscore, toscore);
        }
        /// <summary>
        ...
        {
            return base._IClient.GetRangeFromSortedSet(key, fromRank, toRank);
        }
        /// <summary>
        ...
        {
            return base._IClient.GetRangeFromSortedSetDesc(key, fromRank, toRank);
        }
        /// <summary>
        ...
        {
            return base._IClient.GetRangeWithScoresFromSortedSet(key, fromRank, toRank);
        }
        /// <summary>
        ...
        {
            return base._IClient.GetRangeWithScoresFromSortedSetDesc(key, fromRank, toRank);
        }
        #endregion
        ...
        {
            return base._IClient.RemoveItemFromSortedSet(key, value);
        }
        /// <summary>
        ...
        {
            return base._IClient.RemoveRangeFromSortedSet(key, minRank, maxRank);
        }
        /// <summary>
        ...
        {
            return base._IClient.RemoveRangeFromSortedSetByScore(key, fromscore, toscore);
        }
        /// <summary>
        /// 删除key集合中分数最大的数据
        /// </summary>
        ...
        {
            return base._IClient.PopItemWithHighestScoreFromSortedSet(key);
        }
        /// <summary>
        /// 删除key集合中分数最小的数据
        /// </summary>
        ...
        {
            return base._IClient.PopItemWithLowestScoreFromSortedSet(key);
        }
        #endregion
        ...
        {
            return base._IClient.SortedSetContainsItem(key, value);
        }
        /// <summary>
        ...
        {
            return base._IClient.IncrementItemInSortedSet(key, value, scoreBy);
        }
        /// <summary>
        ...
        {
            return base._IClient.StoreIntersectFromSortedSets(newkey, keys);
        }
        /// <summary>
        ...
        {
            return base._IClient.StoreUnionFromSortedSets(newkey, keys);
        }
        #endregion
    }
}
